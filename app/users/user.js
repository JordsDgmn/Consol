...
export default function UsersPage() {
  ...
  const { setUser } = useUser(); // ✅ Add this to save selected user globally
  ...
  <div className="flex h-[890px] p-8 gap-8 bg-white">
    ...
    <div className="w-1/2 flex flex-col h-full">
      {/* Header and Create New User stay fixed */}
          ...
          <button
            ...
            className={`px-5 py-2 rounded font-semibold transition
              ${newUsername.trim()
                ...
                : 'bg-white border border-purple-400 text-purple-600 cursor-default cursor-pointer hover:shadow-lg' }`}
          >
            + Create New User
          </button>
        </div>
